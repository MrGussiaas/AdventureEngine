package objects.restoregamedialog;
...
import objects.savegamedialoge.TextBox;
...
public class RestoreGameDialog extends ConcreteDrawableObject implements
	...
	private IDrawableObject saveBtn = new RestoreButton("Restore");
	...
	public static IGameObject getInstance(){
		if(instance == null){
			instance = new RestoreGameDialog();
		}
		return instance;
	}
	

	private RestoreGameDialog(){
		try {
