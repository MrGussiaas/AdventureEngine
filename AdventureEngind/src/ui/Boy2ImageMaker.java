...
public class Boy2ImageMaker {
	...
	private Boy2ImageMaker(){
		...
		try {
			...
			bufImage = (BufferedImage) policy.renderImage(ImageIO.read(new File(globalvariables.constants.IMAGE_LOCATION+"backally\\kidright1.bmp")));
			walkImageMaker.addDxPosImage(bufImage);
			bufImage = (BufferedImage) policy.renderImage(ImageIO.read(new File(globalvariables.constants.IMAGE_LOCATION+"backally\\kidright2.bmp")));
			walkImageMaker.addDxPosImage(bufImage);
			bufImage = (BufferedImage) policy.renderImage(ImageIO.read(new File(globalvariables.constants.IMAGE_LOCATION+"backally\\kidright1.bmp")));
			walkImageMaker.addDxPosImage(bufImage);
			bufImage = (BufferedImage) policy.renderImage(ImageIO.read(new File(globalvariables.constants.IMAGE_LOCATION+"backally\\kidright3.bmp")));
			walkImageMaker.addDxPosImage(bufImage);
