...
public class LyafettePark6 extends ConcreteRoom {
	public LyafettePark6(){
		
		setId(8);
		
		IDrawableObject background = new BackgroundObject();
		
		background.setSpriteFile(globalvariables.constants.IMAGE_LOCATION+"whitehouse"+File.separatorChar+"layafettepark6.bmp");
