...
public class ConstitutionAndFifteenth extends ConcreteRoom {
	public ConstitutionAndFifteenth(){
		
		setId(19);
		
		IDrawableObject background = new BackgroundObject();
		background.setSpriteFile(globalvariables.constants.IMAGE_LOCATION+"whitehouse"+File.separatorChar+"fifteenthandconstitution.bmp");
