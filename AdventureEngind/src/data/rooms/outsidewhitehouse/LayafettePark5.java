...
public class LayafettePark5 extends ConcreteRoom {
	public LayafettePark5(){
		
		setId(14);
		
		IDrawableObject background = new BackgroundObject();
		background.setSpriteFile(globalvariables.constants.IMAGE_LOCATION+"whitehouse"+File.separatorChar+"layafettepar5.bmp");
