...
public class SouthPlNW extends ConcreteRoom {
	public SouthPlNW(){
		
		setId(10);
		
		IDrawableObject background = new BackgroundObject();
		background.setSpriteFile(globalvariables.constants.IMAGE_LOCATION+"whitehouse"+File.separatorChar+"southplnw.bmp");
