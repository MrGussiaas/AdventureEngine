...
public class BackAlly extends ConcreteRoom {
	public BackAlly(){
		...
		boy1.setSpriteFile(".\\images\\backally\\kidkneel1.bmp");
		boy2.setSpriteFile(".\\images\\backally\\kidright1.bmp");
		
		fireCracker.setSpriteFile(".\\images\\backally\\firecrackerunlimit.bmp");
		...
		eastWall.setSpriteFile(".\\images\\backally\\eastWall.bmp");
		...
		background.setSpriteFile(".\\images\\backally\\back_ally.bmp");
